...
const NotificationModal = ({ isOpen, onClose, notification }) => {
  ...
  return (
    <div className="fixed inset-0 bg-light/60 flex items-center justify-center z-50 transition-opacity duration-300">
      <div className="bg-light-background rounded-xl shadow-2xl w-full max-w-lg transform transition-all duration-300 scale-100 opacity-100">
        <div className="flex justify-between items-center p-6 border-b border-gray-700">
          <h2 className="text-xl font-bold text-black">Notification Details</h2>
          <button
            onClick={onClose}
