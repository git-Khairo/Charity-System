            ...
            >
                <div className="flex items-center gap-3 p-6 border-b border-gray-200">
                    ...
                    <div className="flex flex-col">
                        <h1 className="text-lg font-bold text-gray-900">{authUser.name} Panel</h1>
                ...
                <nav className="flex flex-col gap-2 p-4">
                    ...
                    <Link to={'/logout'} className="flex items-center gap-3 px-4 py-2 text-lg text-gray-500 font-medium hover:bg-indigo-50 hover:text-indigo-600 rounded-lg transition-colors duration-200">
                        <svg className="w-5 h-5" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
                            <path d="M17 16l4-4m0 0l-4-4m4 4H7m5 4v-7a3 3 0 00-3-3H5" strokeLinecap="round" strokeLinejoin="round"></path>
                        </svg>
                        <span>Logout</span>
                    </Link>
                </nav>
