...
export default function About() {
  return (
    <div id="about-page" className="min-h-screen bg-white pt-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          {[
            ...
            <div key={idx} className="text-center">
              <div className="w-16 h-16 bg-primary/10 rounded-full flex items-center justify-center mx-auto mb-4">
                <i className={`${item.icon} text-[#002366] ri-2x`}></i>
              </div>
        ...
        <div className="text-center mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            {[
              ...
              <div key={idx}>
                <div className="text-4xl font-bold text-[#435b8f] mb-2">{item.value}</div>
        ...
        <div className="text-center">
         ...
         <button className="bg-[#002366] text-white px-8 py-3 rounded-md hover:bg-blue-900 transition-colors text-lg whitespace-nowrap"
>
  Get Started
</button>
        </div>
